...
```
$ python rleapp.py -t <zip | tar | fs | gz | raw> -i <path_to_extraction> -o <path_for_report_output>
```
...
This runs RLEAPP end to end on your extraction and prints ready-to-paste `sample_data`
