...
def pickModules():
    ...
    for plugin in sorted(loader.plugins, key=lambda p: p.category.upper()):
        ...
        mlist[plugin] = tk.BooleanVar(value=True)
...
title_label = ttk.Label(
    title_frame, 
    text='Returns, Logs, Events, And Protobuf Parser', 
    font=('Helvetica 22'))
title_label.pack(pady=4)
github_label = ttk.Label(
    title_frame, 
    text='https://github.com/abrignoni/RLEAPP', 
    font=('Helvetica 14'))
...
timezone_offset.master.option_add( '*TCombobox*Listbox.foreground', 'black')
