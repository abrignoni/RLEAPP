...
def finish_crunch(crunch_successful, out_params):
    ...
    if crunch_successful:
        ...
        history.record_recent_run(leapp_name.lower(), rleapp_version, lava_project_path)
...
rleapp_logo_label.pack(side='left')
...
input_frame = ttk.LabelFrame(
    main_window,
    text=(' Select the file or directory containing the data to be parsed  (tar, zip, gz, raw image, .E01 acquisition, or a folder): '))
