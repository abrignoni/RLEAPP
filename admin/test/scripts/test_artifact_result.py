...
class TestReplayKeepsPythonText(ArtifactResultTestCase):
    ...
    def test_list_path_stores_python_text(self):
        ...
        # 1 or 0. The datetime column still stores the float epoch.
        self.assertEqual(stored, [('35.65956623101914', 'True', 1721575007.357843),
                                  ('670162.147879839', 'False', 1721575007.357843)])
