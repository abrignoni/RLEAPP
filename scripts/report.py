...
def create_index_html(reportfolderbase, time_in_secs, time_hms, extraction_type, image_input_path,
    ...
    if lava_only:
        tab1_content += \
            """
                ...
                This report contains artifacts that are likely to return too much data to be viewed
                  in a Web browser.<br>
                Please review the <i>'LAVA only artifacts'</i> tab for a listing of those artifacts
                 and information on how to open this report using LAVA.
                </p>
            """
    tab1_content += \
        """
    ...
    body_description = 'RLEAPP is an open source project that aims to parse service provider returns '\
