...
def get_icon_name(category, artifact):
    ...
    if category.find('ACCOUNT') >=0:
        ...
        elif artifact.find('CHROME DEVICE INFO') >=0: icon = 'chrome'
        elif artifact.find('CHROME EXTENSIONS') >=0: icon = 'tool'
        elif artifact.find('CHROME OS SETTINGS') >=0: icon = 'settings'
        elif artifact.find('CHROME READING LIST') >=0: icon = 'book'
        elif artifact.find('CHROME SEARCH ENGINES') >=0: icon = 'search'
        elif artifact.find('CHROME OMNIBOX') >=0: icon = 'search'
        elif artifact.find('FITBIT ACCOUNT PROFILE') >=0: icon = 'user'
        elif artifact.find('FITBIT ACTIVITY GOALS') >=0: icon = 'check-circle'
        elif artifact.find('FITBIT COMPUTED TEMPERATURE') >=0: icon = 'thermometer'
        elif artifact.find('FITBIT OXYGEN SATURATION') >=0: icon = 'droplet'
        ...
        elif artifact == 'GOOGLE LOCATION HISTORY - LOCATION HISTORY': icon = 'map-pin'
        ...
        elif artifact == 'GOOGLE PROFILE': icon = 'user'
    ...
    elif category == 'GOOGLE TAKEOUT SEMANTIC LOCATIONS BY MONTH':            icon = 'map-pin'
    ...
    elif category == 'GOOGLE RETURNS MY ACTIVITY SEARCH':            icon = 'search'
    elif category == 'GOOGLE RETURNS YOUTUBE SUBS INFO':            icon = 'search'
    elif category == 'GOOGLE RETURNS ACCOUNT TARGET ASSOC. PHONE':            icon = 'target'
    elif category == 'GOOGLE RETURNS ACCOUNT TARGET ASSOC. COOKIES':            icon = 'target'
    elif category == 'GOOGLE RETURNS GOOGLE PLAY STORE DEVICES':            icon = 'tablet'
    elif category == 'GOOGLE RETURNS GOOGLE PLAY INSTALLS':            icon = 'shield'
    elif category == 'GOOGLE RETURNS GOOGLE PLAY LIBRARY':            icon = 'book-open'
    elif category == 'GOOGLE RETURNS GOOGLE PLAY USER REVIEWS':            icon = 'book-open'
