...
def get_googlelinkedbycookies(files_found, report_folder, seeker, wrap_text, time_offset):
    ...
    for file_found in files_found:
        ...
        if num_entries > 0:
            ...
            report.start_artifact_report(report_folder, f'Linked by Cookies Report {reportcount}')
            report.add_script()
