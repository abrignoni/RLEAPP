...
def get_fbigPhotos(files_found, report_folder, seeker, wrap_text, time_offset):
    data_list = []
    for file_found in files_found:
        ...
        if data_list:
            ...
            #tsvname = f'Facebook Instagram - Photos - {rfilename}'
...
__artifacts__ = {
        "fbigPhotos": (
            ...
            ('*/index.html', '*/preservation*.html', '*/linked_media/media_*'),
            get_fbigPhotos)
}