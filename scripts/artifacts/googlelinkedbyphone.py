__artifacts_v2__ = {
    "googlelinkedbyphone": {
        "name": "Google Returns - Linked By Phone",
        "description": "Google Account Target Association linked-by-phone records from a Google "
                       "law enforcement return (*.LinkedByPhone.csv).",
        "author": "@AlexisBrignoni",
        "creation_date": "2023-05-16",
        "last_update_date": "2026-06-28",
        "requirements": "none",
        "category": "Google Returns Account Target Assoc. Phone",
        "notes": "Dynamic-schema CSV: column headers are read from the file's first row and made "
                 ...
                 "(TEXT) since the column set varies per return (so phone-number columns are not "
                 "individually typed).",
        "paths": ('*/*GoogleAccountTargetAssociation.LinkedByPhone_*/'
                  'Google Account Target Association/*.LinkedByPhone.csv',),
...
@artifact_processor
def googlelinkedbyphone(context):
