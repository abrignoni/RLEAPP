...
def get_twitterReturns(files_found, report_folder, seeker, wrap_text):
    ...
    if data_list_tweets:
        ...
        report.write_artifact_data_table(data_headers, data_list_tweets, file_found, html_no_escape=['Media'])
    ...
    if data_list_screen_name_changes:
        ...
        report.write_artifact_data_table(data_headers, data_list_screen_name_changes, file_found)
        report.end_artifact_report()
    ...
    if data_list_saved_searches:
        ...
        report.write_artifact_data_table(data_headers, data_list_saved_searches, file_found)
        report.end_artifact_report()
    ...
    if data_list_profile_description:
        ...
        report.write_artifact_data_table(data_headers, data_list_profile_description, file_found)
        report.end_artifact_report()
    ...
    if data_list_lists_created:
        ...
        report.add_script()
        data_headers = ('List',)
        report.write_artifact_data_table(data_headers, data_list_lists_created, file_found)
        report.end_artifact_report()
    ...
    if data_list_following:
        ...
        report.write_artifact_data_table(data_headers, data_list_following, file_found)
        report.end_artifact_report()
    ...
    if data_list_followers:
        ...
        report.write_artifact_data_table(data_headers, data_list_followers, file_found)
        report.end_artifact_report()
    ...
    if data_list_account:
        ...
        report.write_artifact_data_table(data_headers, data_list_account, file_found)
        report.end_artifact_report()
    ...
    if data_list_dms:
        ...
        report.write_artifact_data_table(data_headers, data_list_dms, file_found, html_no_escape=['Media'])
        report.end_artifact_report()
    ...
    if data_list_groupdm:
        ...
        report.add_script()
        data_headers = ('Timestamp', 'Conversation ID', 'Sender ID', 'Recipient ID', 'Message', 'Media')
        report.write_artifact_data_table(data_headers, data_list_groupdm, file_found, html_no_escape=['Media'])
        report.end_artifact_report()
