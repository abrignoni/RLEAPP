...
icon_mappings = \
{
    ...
    'KIK': {
        'KIK - SUBSCRIBER INFO': 'user',
        'KIK - SUBSCRIBER PROFILE PICS': 'image',
        'KIK - SUBSCRIBER EVENTS': 'activity',
        'KIK - GROUP LEGEND': 'users',
        'KIK - CHAT MESSAGES (TEXT)': 'message-square',
        'KIK - CHAT MESSAGES (MEDIA)': 'image',
        'KIK - SENT CHATS (LOG)': 'message-square',
        'KIK - SENT & RECEIVED CHATS (LOG)': 'message-square',
        'KIK - PLATFORM CHAT SENT (LOG)': 'message-square',
        'KIK - PLATFORM CHAT SENT & RECEIVED (LOG)': 'message-square',
        'KIK - GROUP MESSAGES RECEIVED (LOG)': 'users',
        'KIK - GROUP MESSAGES SENT (LOG)': 'users',
        'KIK - FRIENDS ADDED (LOG)': 'user-plus',
        'KIK - BLOCKED USERS (LOG)': 'user-x',
        'KIK - BINDS (LOG)': 'smartphone',
